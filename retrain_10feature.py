"""
Retrain Keras model on the 10 features the Android app sends.
...
print("Starting 10-feature retraining pipeline...")
...
if model_path.exists():
    model_path.rename(APP_DIR / 'keras_model_improved.keras.bak')
if scaler_path.exists():
    scaler_path.rename(APP_DIR / 'scaler_improved.pkl.bak')
...
# Sanity predictions for a few cases
samples = [
